...
for Epd5in83<SPI, CS, BUSY, DC, RST, DELAY>
    where
        ...
        DELAY: DelayMs<u8>,
{
    fn update_color_frame(&mut self, spi: &mut SPI, black: &[u8], chromatic: &[u8]) -> Result<(), SPI::Error> {
    ...
    fn update_chromatic_frame(&mut self, spi: &mut SPI, chromatic: &[u8]) -> Result<(), SPI::Error> {
        self.wait_until_idle();
    ...
    DELAY: DelayMs<u8>,
{
    ...
    fn update_partial_frame(
        ...
        self.send_data(spi, &[hrst_upper, hrst_lower, hred_upper, hred_lower, vrst_upper, vrst_lower, vred_upper, vred_lower, pt_scan])?;
